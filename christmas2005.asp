...
<!--
var ds1 = new Spry.Data.XMLDataSet("pictures.xml", "pictures/name");
var ds2 = new Spry.Data.XMLDataSet("Lodge Pictures/index.xml", "album/images/image/firstImage");
var ds3 = new Spry.Data.XMLDataSet("file:///C|/Documents and Settings/David Johnson/My Documents/WarrantyReg.xml", "dataroot/WarrantyReg",{sortOnLoad:"CustomerID",sortOrderOnLoad:"ascending"});
//-->
</script>
</head>
...
<li><a href="archives.html" id="drop">ARCHIVES<!--[if IE 7]><!--></a><!--<![endif]-->
	<!--[if lte IE 6]><table><tr><td><![endif]-->
	<ul>
...
<li><a href="gallery.asp">GALLERY<!--[if IE 7]><!--></a><!--<![endif]-->
	<!--[if lte IE 6]><table><tr><td><![endif]-->
	<!--<ul>
...
<h1>Picture Gallery</h1>
  ...
  <p>The following galleries should give you an idea of the kinds of activities
    ...
    <h3>
    Choose from the following.    </h3>
     
     <div spry:region="ds2"><img src="{images}"/>{images}<img src="{firstImage}"/>{albumName}{ds2::firstImage}{ds2::albumItemCount}</div>
    <ul id="pictures">
    <li>
     
      <a href="#">Christmas 2005</a></li>
