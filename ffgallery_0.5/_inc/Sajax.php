<?php	
/*
 Modified with ycavan's code to allow sending php function return values directly
 to an id in the HTML.
 http://www.modernmethod.com/sajax/forum/viewtopic.php?t=76
 
 2006-02-07
 Modified to work with Opera
 	Change:
		if ( theItem.getAttribute("value") == null) {	
	to	
		if ( theItem.getAttribute("innerHTML") != null ||
		theItem.getAttribute("value") == null) {
	@ line 170
*/
...
// Change to work in Opera			   if ( theItem.getAttribute("value") == null) {                                  
                                       if ( theItem.getAttribute("innerHTML") != null || theItem.getAttribute("value") == null) {
                                       //   alert("innerHTML!");
