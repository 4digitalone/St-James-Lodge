...
<?    
	// output the SAJAX code   
	sajax_show_javascript();
?>
    </script>
    <script type="text/javascript" src='./_inc/ffgallery_main.js.php'></script>
</head>
<body onLoad="<? 
...
?>" onUnload="unLoadPage()">
    ...
    <table class='z_tbl'>
    <tr>
        <td class='z_td_tr'> <? echo $DEFAULT_IMAGE_HEADER; ?><div class='img_title' id='zimg_title'></div><div id='zimg_desc'></div><? echo $DEFAULT_IMAGE_FOOTER; ?><div class='z_full' id='z_full'></div></td>
        <td class='z_td'><div id='zimg' onMouseDown="document.getElementById('zoom').style.visibility='hidden';"></div><div class='close' onMouseDown="document.getElementById('zoom').style.visibility='hidden';"><? echo CLICK_TO_CLOSE; ?> X</div></td>
    </tr>
    </table>
    </div>
	<div id="overlay_f" onMouseDown="this.style.display='none';var im = document.getElementById('im');im.src = '';">
		<img id="im">
	</div>
</body>
</html>